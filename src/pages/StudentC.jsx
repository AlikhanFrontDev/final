    ...
    return (
        <>
            ...
            <div style={{ marginLeft: '220px' }} className='title'>
                <h1 className='titleName'>Students</h1>
                    ...
                    <div className="modal">
                        ...
                        <div className="modal-content">
                            <form className='addForm center' style={{ minHeight: '200px' }}>
                                <h3 className='add welcome first'>Make payment from Student</h3>
                                <input type="text" className='inputForm ' placeholder='Select Student' />
